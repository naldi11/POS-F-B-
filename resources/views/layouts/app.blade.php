                    ...
                    <nav class="mt-2 py-4 px-4 lg:mt-4 lg:px-6">
                        ...
                        <div>
                            ...
                            <ul class="mb-6 flex flex-col gap-1.5">
                                ...
                                <li>
                                    <a href="{{ route('admin.users') }}" wire:navigate class="group relative flex items-center gap-3 rounded-xl px-4 py-3 font-medium text-orange-50 duration-300 ease-in-out hover:bg-orange-700/80 hover:text-white {{ request()->routeIs('admin.users') ? 'bg-orange-700 text-white shadow-inner' : '' }}">
                                        <svg class="w-5 h-5 {{ request()->routeIs('admin.users') ? 'text-white' : 'text-orange-200 group-hover:text-white' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                                        Manajemen Pengguna
                                    </a>
                                </li>
                                <li>
