                                ...
                                <tr class="bg-white border-b border-gray-50 hover:bg-gray-50/50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @if($menu->is_best_seller)
                                            <span class="inline-flex mt-1 items-center px-2 py-0.5 rounded text-[10px] font-bold bg-orange-100 text-orange-800">
                                                <svg class="mr-1 w-3 h-3 text-orange-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                                Best Seller
                                            </span>
                                        @endif
                                    </td>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 max-h-[70vh] overflow-y-auto">
                        ...
                        <div class="mb-4">
                            ...
                            <div x-data="{
                                ...
                                <input type="file" wire:model="image" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" title="Klik atau Drop gambar di sini" accept="image/jpeg,image/png,image/jpg,image/webp">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Pengaturan Best Seller</label>
                            <select wire:model="best_seller_status" class="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 transition">
                                <option value="auto">Otomatis (Berdasarkan Top 3 Penjualan)</option>
                                <option value="yes">Ya (Selalu jadikan Best Seller)</option>
                                <option value="no">Tidak (Jangan jadikan Best Seller)</option>
                            </select>
                            @error('best_seller_status') <span class="text-red-500 text-xs italic mt-1 block">{{ $message }}</span> @enderror
                        </div>
